...
let nRemainingCharacters = "",
  remainingCharacters = "";

// handling prompt data reset start
...
function handleTextRemainingCharacters() {
  remainingCharacters = Math.max(0, maxLimit - textContent.length);
  nRemainingCharacters = maxLimit - nTextContent.length;
}
...
const GenerateImage = () => {
  ...
  let [ImagesNosCount, setImagesNosCount] = useState(0);
  let [PromptCount, setPromptCount] = useState(0);
  let [ControlWeight, setControlWeight] = useState(0);
  ...
  function handleReset(type) {
    ...
    if (type === "seed") {
      ...
      setControlWeight((ImagesNosCount = 0));
    } else if (type === "Prompt") {
      PromptCount = 0;
      ...
      <main>
        <div className="relative border-0 h-[92vh] p-2 w-full bg-slate-950">
          ...
          <div className="flex h-full items-center justify-between">
            {/* side tools start*/}
            <div className="w-[3.5vw] rounded h-full mr-2 -ml-2 border-0 bg-gray-900 flex items-center justify-between py-5 flex-col">
              ...
              <div>
                ...
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 320 512"
                  className=" w-[22px] h-[22px] mb-6 ring-2 rounded-full p-1 ring-purple-800"
                >
                  <path
                    fill="#6f1ed2"
                ...
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 512 512"
                  className=" w-[22px] h-[22px] mb-6 scale-x-[-1]"
                >
                  <path
                    fill="#6f1ed2"
            ...
            <div className="mr-2 p-2 w-[65vw] border-0 h-full bg-gray-900 rounded">
              {/* image view start */}
              {/* image view  end */}
            ...
            <div className="w-[30vw] px-3 h-full bg-gray-900 rounded">
              <div className="w-full h-[83vh] overflow-scroll no-scrollbar bg-gray-900">
                    ...
                    {isPromptVisible && (
                      <div className="my-2">
                        ...
                        <div className="border-2 flex flex-col items-end justify-end rounded border-gray-900 focus:border-gray-800 w-full">
                          ...
                          />
                          <p className="remainingCharacters relative float-right mr-1.5 text-gray-500">
                            {remainingCharacters}/450
                          </p>
                        </div>
                        {/* -ve */}
                  ...
                  <div className="w-full bg-gray-950 h-fit rounded mb-3 p-3 overflow-scroll no-scrollbar">
                    ...
                    <div className="flex items-center justify-between px-2 mb-2 rounded border-indigo-900 border-2">
                      ...
                      >
                        ...
                        <p className="tracking-wide font-poppins">Settings</p>
                      </button>
                      {isSettingVisible ? (
                        <img src={down} alt="" className="w-[30px] h-[30px] " />
                      ) : (
                      ...
                      <div className="">
                        ...
                        <div className="mb-1 mt-4 flex h-6 w-full justify-between items-center">
                          ...
                          <div className=" flex justify-center items-center">
                            <input
                              id="PromptCount"
                              type="number"
                              className="rounded mt-2 w-12 focus:outline-none bg-gray-900 text-gray-200 px-3 h-6 text-center text-lg mb-2 p-1"
                            />
                            <button
                        ...
                        <div className="mb-1 mt-2 flex h-6 w-full justify-between items-center">
                          ...
                          <div className="px-1 flex justify-between items-center">
                            <input
                              id="ControlWeight"
                              className="rounded mt-2 w-12 bg-gray-900 text-gray-200 px-3 h-6 text-center text-lg mb-2 p-1"
                              type="number"
                            />
                            <button
                        ...
                        <div className="mb-1 mt-2 flex items-center justify-between w-full open-sans md:hidden sm:flex lg:flex 2xl:flex">
                          ...
                          <input
                            type="number"
                            name=""
                            className="w-[25%] 2xl:w-[5vw] pl-1 bg-transparent ml-[20%] 2xl:ml-[43%] 2xl:mr-4 h-8 border-2 text-white border-b-2 md:mb-2 border-gray-910 border-t-0 border-l-0 border-r-0 outline-none"
