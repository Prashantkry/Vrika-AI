...
export default function SignUpPage() {
  // image work start
  const [imageData, setImageData] = useState({ myFile: "" });
      ...
      <div className="bg-gray-950 h-[92vh] flex items-center justify-around border-0">
        <div className="w-[60vw] mainDivSignUp2 md:flex items-center justify-center border-2">
          <div className="bg-gray-900 w-[80%] mainDivSignUp h-full shadow-lg rounded px-2 py-6">
            ...
            <p
              tabIndex={0}
              className="focus:outline-none flex items-center justify-between text-sm mt-4 font-medium leading-none text-gray-500"
            >
            ...
            <div className="mt-4">
              ...
              <span className="ml-2 -mt-2 text-xs text-gray-300">
                I agree to Vrika AI Terms of Services
              </span>
              <br />
            </div>
            <div className="mt-8">
              <button
                role="button"
                className="focus:ring-2 focus:ring-offset-2 focus:ring-indigo-700 text-sm font-semibold leading-none text-white focus:outline-none bg-indigo-700 border-0 rounded hover:bg-indigo-600 py-4 w-full"
